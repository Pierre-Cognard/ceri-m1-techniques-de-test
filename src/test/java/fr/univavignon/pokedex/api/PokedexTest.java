...
public class PokedexTest {
    ...
    public void getPokemonMetadataTest() throws PokedexException {
        ...
        assertEquals(metadata, pokedex.getPokemonMetadata(1));
    }
    ...
    public void createPokemonTest() {
        ...
        assertEquals(pokemon, pokedex.createPokemon(0, 110, 60, 400, 4));
    }
    ...
    public void addAndGetPokemonTest() throws PokedexException {
        ...
        assertEquals(pokemon, pokedex.getPokemon(id));
    }
    ...
    public void getPokemonsTest() {
        ...
        Pokemon pokemon2 = new Pokemon(0, "Bulbasaur", 49, 49, 90, 110, 60, 400, 4, 56.0);
